...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DqyFF6gq.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DVF5Nmsn.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, asyncDataDefaults as d, entry_default as default, encodeRoutePath as e, createError as f, navigateTo as n, resolveRouteObject as r, useRouter as u };
