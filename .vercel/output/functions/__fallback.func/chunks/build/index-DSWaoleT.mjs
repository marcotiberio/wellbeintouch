...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderClass, ssrRenderAttr, ssrRenderTeleport, ssrRenderStyle, ssrIncludeBooleanAttr } from 'vue/server-renderer';
...
function computeScore(reports) {
  ...
  const penalties = reports.map((r) => {
    const stageW = STAGE_WEIGHTS[r.stage] ?? 1;
    const durM = DURATION_MULTIPLIERS[r.duration] ?? 1;
    return stageW * durM;
  });
...
const INDUSTRY_MAP = Object.fromEntries(
...
function buildCompanies(reports, industryLookup) {
  ...
  for (const [name, rows] of grouped) {
    ...
    const topRoleType = mode(rows.map((r) => r.role_type));
    result.push({
      name,
...
function useCompanyData() {
  ...
  const companies = useState("wbit-companies", () => SEED_COMPANIES);
  ...
  const fetchLive = async () => {
    ...
    try {
      ...
      const industryLookup = { ...INDUSTRY_MAP };
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(isOpen)) {
          _push2(`<div class="modal-overlay" role="dialog" aria-modal="true" data-v-db607c95><div class="modal" data-v-db607c95><div class="modal-header" data-v-db607c95><div class="modal-header-text" data-v-db607c95><div class="modal-title" data-v-db607c95>File a ghosting report</div><div class="modal-subtitle" data-v-db607c95>Anonymous · Public record · Takes about 2 minutes</div></div><button class="modal-close" data-v-db607c95>Close</button></div>`);
          if (!unref(showSuccess)) {
            _push2(`<form novalidate data-v-db607c95><div class="form-body" data-v-db607c95><div class="form-section-label" data-v-db607c95>Who ghosted you?</div><div class="form-row" data-v-db607c95><div class="${ssrRenderClass([{ error: unref(errors).company }, "field"])}" data-v-db607c95><label class="form-label" data-v-db607c95>Company name <span class="req" data-v-db607c95>*</span></label><input${ssrRenderAttr("value", unref(company))} type="text" placeholder="e.g. Acme Corp" autocomplete="off" data-v-db607c95></div><div class="${ssrRenderClass([{ error: unref(errors).role }, "field"])}" data-v-db607c95><label class="form-label" data-v-db607c95>Role applied for <span class="req" data-v-db607c95>*</span></label><input${ssrRenderAttr("value", unref(role))} type="text" placeholder="e.g. Senior Visual Designer" data-v-db607c95></div></div><div class="form-row full" style="${ssrRenderStyle({ "margin-bottom": "18px" })}" data-v-db607c95><div class="${ssrRenderClass([{ error: unref(errors).roleType }, "field"])}" data-v-db607c95><label class="form-label" data-v-db607c95>Role type <span class="req" data-v-db607c95>*</span></label><div class="toggle-row" data-v-db607c95><!--[-->`);
            ssrRenderList(roleTypeOptions, (opt) => {
              _push2(`<label class="${ssrRenderClass([{ active: unref(roleType) === opt.value }, "toggle-label"])}" data-v-db607c95>${ssrInterpolate(opt.label)}</label>`);
            });
            _push2(`<!--]--></div></div></div><hr class="divider" data-v-db607c95><div class="form-section-label" data-v-db607c95>When did they go silent?</div><div class="form-row full" style="${ssrRenderStyle({ "margin-bottom": "18px" })}" data-v-db607c95><div class="${ssrRenderClass([{ error: unref(errors).stage }, "field"])}" data-v-db607c95><label class="form-label" data-v-db607c95>Stage when ghosted <span class="req" data-v-db607c95>*</span></label><div class="toggle-row" data-v-db607c95><!--[-->`);
            ssrRenderList(stageOptions, (opt) => {
              _push2(`<label class="${ssrRenderClass([{ active: unref(stage) === opt.value }, "toggle-label"])}" data-v-db607c95>${ssrInterpolate(opt.label)}</label>`);
            });
            _push2(`<!--]--></div></div></div><div class="form-row full" style="${ssrRenderStyle({ "margin-bottom": "18px" })}" data-v-db607c95><div class="${ssrRenderClass([{ error: unref(errors).duration }, "field"])}" data-v-db607c95><label class="form-label" data-v-db607c95>How long did the process run? <span class="req" data-v-db607c95>*</span></label><div class="toggle-row" data-v-db607c95><!--[-->`);
            ssrRenderList(durationOptions, (opt) => {
              _push2(`<label class="${ssrRenderClass([{ active: unref(duration) === opt.value }, "toggle-label"])}" data-v-db607c95>${ssrInterpolate(opt.label)}</label>`);
            });
            _push2(`<!--]--></div></div></div><hr class="divider" data-v-db607c95><div class="form-section-label" data-v-db607c95>Anything to add?</div><div class="form-row full" data-v-db607c95><div class="field" data-v-db607c95><label class="form-label" data-v-db607c95>Optional note <span class="opt" data-v-db607c95>(one or two sentences)</span></label><textarea placeholder="&quot;They asked for a 3-day case study then disappeared.&quot;" data-v-db607c95>${ssrInterpolate(unref(notes))}</textarea></div></div>`);
            if (unref(submitError)) {
              _push2(`<div class="submit-error" data-v-db607c95>${ssrInterpolate(unref(submitError))}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="form-footer" data-v-db607c95><div class="form-footer-note" data-v-db607c95> Anonymous — no account required.<br data-v-db607c95>All submissions are public record. </div><button type="submit" class="btn-primary"${ssrIncludeBooleanAttr(unref(isSubmitting)) ? " disabled" : ""} data-v-db607c95>${ssrInterpolate(unref(isSubmitting) ? "Submitting…" : "Submit report")}</button></div></form>`);
          } else {
            _push2(`<div class="modal-success" data-v-db607c95><div class="stamp" data-v-db607c95>Received</div><p class="success-text" data-v-db607c95> Your report has been filed and will contribute to this company&#39;s public score. Thank you for helping other candidates make a more informed decision. </p><div class="success-ref" data-v-db607c95>Ref: ${ssrInterpolate(unref(refCode))}</div><div class="success-support" data-v-db607c95><p class="success-support-text" data-v-db607c95> If the hiring process has been weighing on you, you&#39;re not alone — and talking to someone can help. </p><a href="https://www.psychologytoday.com/intl/counsellors" target="_blank" rel="noopener" class="success-support-link" data-v-db607c95> Find a therapist near you → </a></div><div class="success-actions" data-v-db607c95><button class="btn-secondary" data-v-db607c95>Submit another</button><button class="btn-primary" data-v-db607c95>Close</button></div></div>`);
          }
          _push2(`</div></div>`);
        } else {
          _push2(`<!---->`);
...
const __nuxt_component_7 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-db607c95"]]), { __name: "ReportModal" });
const FALLBACK = {
...
function usePageContent() {
  ...
  useAsyncData("sanity-home", async () => {
    try {
      const client = createClient$1({ projectId, dataset, apiVersion, useCdn });
...
//# sourceMappingURL=index-DSWaoleT.mjs.map
